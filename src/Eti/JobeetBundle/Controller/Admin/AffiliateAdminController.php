<?php 
namespace Eti\JobeetBundle\Controller\Admin;
...
class AffiliateAdminController extends Controller
{
        ...
        try {
            foreach($selectedModels as $selectedModel) {
                ...
                $message = \Swift_Message::newInstance()
                    ...
                    ->setBody(
                        $this->renderView('EtiJobeetBundle:Affiliate:email.txt.twig', array('affiliate' => $selectedModel->getToken())))
                ;
    ...
    public function activateAction($id)
    {
       if($this->admin->isGranted('EDIT') === false) {
        ...
        $affiliate = $em->getRepository('EtiJobeetBundle:Affiliate')->findOneById($id);
        ...
        try {
            ...
            $message = \Swift_Message::newInstance()
                ...
                ->setBody(
                    $this->renderView('EtiJobeetBundle:Affiliate:email.txt.twig', array('affiliate' => $affiliate->getToken())))
            ;
