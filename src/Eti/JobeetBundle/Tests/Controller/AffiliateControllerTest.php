...
use Symfony\Component\Dom\Crawler\Crawler;
...
class AffiliateControllerTest extends WebTestCase
{
    ...
    public function testAffiliateForm()
    {
        ...
        $this->assertEquals('Eti\JobeetBundle\Controller\AffiliateController::newAction', $client->getRequest()->attributes->get('_controller'));
        ...
        $client->submit($form);
        $this->assertEquals('Eti\JobeetBundle\Controller\AffiliateController::createAction', $client->getRequest()->attributes->get('_controller'));
 
        $kernel = static::createKernel();
        $kernel->boot();
        $em = $kernel->getContainer()->get('doctrine.orm.entity_manager');
 
        $query = $em->createQuery('SELECT count(a.email) FROM EtiJobeetBundle:Affiliate a WHERE a.email = :email');
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals('Eti\JobeetBundle\Controller\AffiliateController::waitAction', $client->getRequest()->attributes->get('_controller'));
