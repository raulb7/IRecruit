...
class ApiControllerTest extends WebTestCase
{
    ...
    public function testList()
    {
        ...
        $this->assertEquals('Eti\JobeetBundle\Controller\ApiController::listAction', $client->getRequest()->attributes->get('_controller'));
        $this->assertTrue($crawler->filter('description')->count() == 1);
