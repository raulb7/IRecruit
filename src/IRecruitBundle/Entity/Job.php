...
class Job
{
    ...
    /**
     * @var \IRecruitBundle\Entity\Category
     */
    private $category;
     ...
     * Get category
     *
     * @return \IRecruitBundle\Entity\Category
     */
     ...
     * @return Job
     */
    public function setCategory(\IRecruitBundle\Entity\Category $category = null)
    {
    ...
    {
        return IRecruit::slugify($this->getPosition());
    }
 
    public function getLocationSlug()
    {
        return IRecruit::slugify($this->getLocation());
    }
...
//        }
     ...
     * @return Job
     */
    public function addUser(\IRecruitBundle\Entity\User $user)
    {
        $this->users[] = $user;
     ...
     * @param \IRecruitBundle\Entity\User $user
     */
    public function removeUser(\IRecruitBundle\Entity\User $user)
    {
