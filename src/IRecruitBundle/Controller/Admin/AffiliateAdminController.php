<?php 
namespace IRecruitBundle\Controller\Admin;
...
class AffiliateAdminController extends Controller
{
        ...
        try {
            foreach($selectedModels as $selectedModel) {
                ...
                $message = \Swift_Message::newInstance()
                    ->setSubject('IRecruit affiliate token')
                    ->setFrom('address@example.com')
                    ->setTo($selectedModel->getEmail())
                    ->setBody(
                        $this->renderView('IRecruitBundle:Affiliate:email.txt.twig', array('affiliate' => $selectedModel->getToken())))
                ;
    ...
    public function activateAction($id)
    {
       if($this->admin->isGranted('EDIT') === false) {
        ...
        $affiliate = $em->getRepository('IRecruitBundle:Affiliate')->findOneById($id);
        ...
        try {
            ...
            $message = \Swift_Message::newInstance()
                ...
                ->setBody(
                    $this->renderView('IRecruitBundle:Affiliate:email.txt.twig', array('affiliate' => $affiliate->getToken())))
            ;
